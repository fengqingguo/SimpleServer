package com.server.framework.aspectj;

import com.server.common.annotation.Log;
import com.server.common.enums.BusinessStatus;
import com.server.common.json.JSON;
...
import com.server.system.pojo.SysOperLog;
import com.server.system.service.ISysOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.server.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            // 请求的地址
            String ip = "localhost";//ShiroUtils.getIp();
